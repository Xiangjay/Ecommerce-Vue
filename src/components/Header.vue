  ...
  <header>
    ...
    <div class="menubar">
      <div class="menubar-left">
        <a href=""><img id="logo" src="./../../static/images/logo.jpg" alt=""></a>
      </div>
      <div class="menubar-right">
        <span class="menubar-username" v-if="nickName">Welcome {{nickName}}</span>
        <div class="menubar-links">
          <a href="/home" v-if="!nickName">Login</a>
          <a href="javascript:void(0)" @click="logout">Logout</a>
          <span class="navbar-cart-count" v-if="cartCount>0">{{cartCount}}</span>
          <a href="/#/cart">
            <svg class="menubar-cart-logo">
